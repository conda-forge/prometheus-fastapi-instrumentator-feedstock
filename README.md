...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/prometheus-fastapi-instrumentator-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12103&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/prometheus-fastapi-instrumentator-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `prometheus-fastapi-instrumentator` can be installed with:

```
conda install prometheus-fastapi-instrumentator
```

It is possible to list all of the versions of `prometheus-fastapi-instrumentator` available on your platform with:
